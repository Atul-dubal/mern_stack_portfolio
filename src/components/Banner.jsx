            ...
            <div className='max-w-screen mt-[60px]  flex container mx-auto justify-center space-x-5  bg-white text-black'>
                <div className='flex  flex-col p-6 mt-[30px] justify-between md:flex-row   '>
                    ...
                    <div className='md:w-[60%] text-center space-y-6 order-2 md:order-1 md:mt-[48px]'>
                        ...
                        {/* Email Input */}
                        <label className="input  border-black bg-white text-black flex items-center gap-2 w-72">
                        ...
                        <button className='bg-pink-600 text-[10px]  md:text-sm px-4 py-2 flex start-0 rounded-md hover:bg-pink-300 duration-500 ease-in-out'>Lets Connect</button>
                    </div>
                    {/* Right Side */}

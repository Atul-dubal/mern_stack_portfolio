...
function ProjectCard() {
    return (
        <React.Fragment>
            <div className='flex flex-col md:flex-row justify-start w-[90%] my-5 mx-auto bg-slate-200 border space-y-3 shadow-xl space-x-3 rounded-xl p-3 hover:scale-105 duration-700'>
                ...
                <div className='justify-center w-[100%] md:w-[40%]'>
                <Carousel infiniteLoop={true} useKeyboardArrows={true} showIndicators={false} dynamicHeight={false} autoPlay={true} showStatus={false} showThumbs={false}>
                    <div className='md:w-[80%] flex justify-center flex-row'>
                        <img className='w-[50%] rounded-lg border-black' src='/about_us.jpg' alt='' />
                    </div>
                    <div className='md:w-[80%]'>
                        <img className='w-[50%] rounded-lg border-black' src='/php.png' alt='' />
                    </div>
                </Carousel>
            </div>
        </div>

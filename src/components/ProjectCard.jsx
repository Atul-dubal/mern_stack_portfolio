...
function ProjectCard() {
    return (
        <React.Fragment>
            <div className='flex flex-col md:flex-row justify-start w-[90%] m-5 bg-slate-200 border shadow-xl space-x-3 rounded-xl p-3 hover:scale-105 duration-700'>
                ...
                <div className='justify-self-end w-[100%] md:w-[50%]'>

                    <img className='w-[80%] rounded-lg border-black' src='/about_us.jpg' alt='' />

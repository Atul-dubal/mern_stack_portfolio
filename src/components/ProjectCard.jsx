...
function ProjectCard() {
    return (
        <React.Fragment>
            <div className='flex flex-col md:flex-row justify-start w-[95%] my-5 mx-auto bg-slate-200 border space-y-3 shadow-xl space-x-3 rounded-xl p-3 hover:scale-105 duration-700'>
                ...
                <div className='justify-center w-[100%] md:w-[50%]'>
                    ...
                    <img className='w-[90%] rounded-lg border-black' src='/about_us.jpg' alt='' />
